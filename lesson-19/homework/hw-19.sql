...
BEGIN
    ...
    -- 1️ Vaqtinchalik jadvalni yaratamiz
    ...
    -- 2️ Ma’lumotlarni joylashtiramiz
...
END;
GO
  EXEC sp_UpdateDepartmentSalary @DeptName = 'Sales', @IncreasePercent = 5;
